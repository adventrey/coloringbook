...
public class FileUtils {
    ...
    public static List<LocalImageBean> obtainLocalImages() {
        ...
        String path = Environment.getExternalStorageDirectory().getPath() + "/littleponycoloringbook";
    ...
    public static void deleteAllPaints() {
        File dir = new File(Environment.getExternalStorageDirectory().getPath() + "/littleponycoloringbook");
        if (dir.isDirectory()) {
