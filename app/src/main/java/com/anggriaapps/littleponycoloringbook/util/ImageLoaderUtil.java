...
public class ImageLoaderUtil {
    ...
    public static DisplayImageOptions getOptions() {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                ...
                .showImageForEmptyUri(R.drawable.ic_loadingicon)
                .showImageOnFail(R.drawable.ic_loadingicon).cacheInMemory(false)
    ...
    public static DisplayImageOptions getOpenAllCacheOptions() {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                .showImageOnLoading(getRandomColorDrawable())
                .showImageForEmptyUri(R.drawable.ic_loadingicon)
                .showImageOnFail(R.drawable.ic_loadingicon).cacheInMemory(true)
                .cacheOnDisk(true).considerExifParams(true)
                .bitmapConfig(Bitmap.Config.RGB_565)
                .imageScaleType(ImageScaleType.EXACTLY).build();
        return options;
